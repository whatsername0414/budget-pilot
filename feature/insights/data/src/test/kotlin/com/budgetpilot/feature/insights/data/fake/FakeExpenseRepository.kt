...
class FakeExpenseRepository(
    ...
    private val categoryTotalsByRange: Map<Pair<LocalDate, LocalDate>, List<CategoryTotal>> = emptyMap(),
) : ExpenseRepository {
    ...
    override suspend fun sumByCategory(
        startDate: LocalDate,
        endDate: LocalDate,
    ): Result<List<CategoryTotal>, DataError.Local> = Result.Success(categoryTotalsByRange[startDate to endDate] ?: emptyList())
